...
// Interfaces
import { TaskComment, CreateTaskCommentRequest } from '../../../../shared/interfaces/task.interface';
                ...
                <div class="flex-1">
                  ...
                  @if (comment.files && comment.files.length > 0) {
                    <div class="files-list mb-3">
                      @for (file of comment.files; track file._id) {
            ...
            this.commentsService.createComment(commentData).subscribe({
                next: (newComment) => {
                    ...
                    if (this.selectedFiles().length > 0) {
                        this.uploadFiles(newComment._id);
                    } else {
