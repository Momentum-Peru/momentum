...
// Interfaces
import { Task, CreateTaskRequest, UpdateTaskRequest, TaskStatus } from '../../../../shared/interfaces/task.interface';
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">
          {{ isEditing() ? 'Modifica los datos de la tarea' : 'Completa la información para crear una nueva tarea' }}
        </p>
      </div>
      ...
      <form [formGroup]="taskForm()" (ngSubmit)="onSubmit()" class="space-y-6">
        ...
        <div class="space-y-2">
          ...
          <p *ngIf="taskForm().get('title')?.invalid && taskForm().get('title')?.touched" class="text-red-500 text-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            ...
            <p *ngIf="taskForm().get('status')?.invalid && taskForm().get('status')?.touched" class="text-red-500 text-sm">
          ...
          <div class="space-y-2">
            ...
            <select
              ...
              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              [class.border-red-500]="taskForm().get('priority')?.invalid && taskForm().get('priority')?.touched">
              <option value="">Selecciona la prioridad</option>
              <option value="low">Baja</option>
              <option value="medium">Media</option>
              <option value="high">Alta</option>
            </select>
            <p *ngIf="taskForm().get('priority')?.invalid && taskForm().get('priority')?.touched" class="text-red-500 text-sm">
...
export class NativeTaskFormComponent implements OnInit {
    ...
    private loadUsers(): void {
        ...
        this.usersApiService.list().pipe(take(1)).subscribe({
            next: (users) => {
