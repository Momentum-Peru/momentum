    ...
    <div class="card p-6 max-w-4xl mx-auto">
      ...
      <div class="max-w-xl mx-auto">
        ...
        <div class="border rounded-lg p-6 bg-white shadow-sm">
          ...
          <p class="mb-4 text-gray-600">Sube el archivo Excel con los datos de la planilla o recibos por honorarios.</p>

          <div class="mb-4">
            <label for="payroll-type-select" class="block text-sm font-medium text-gray-700 mb-2">Tipo de Carga</label>
            <p-select
          ...
          >
            <ng-template pTemplate="content" let-files>
                ...
                <div class="flex items-center justify-between p-3 border rounded-lg bg-gray-50 mb-2">
                  <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                      ...
                      <span class="text-xs text-gray-500">{{ file.size / 1024 | number : '1.0-2' }} KB</span>
                    </div>
                  </div>
                </div>
                }
              ...
              <div class="flex flex-col items-center justify-center p-8 text-center cursor-pointer"
                (click)="fileInput.click()">
                <i class="pi pi-cloud-upload text-4xl text-gray-400 mb-2"></i>
                <p class="text-sm text-gray-500">
                  Arrastra y suelta el archivo aquí o haz clic en "Seleccionar Excel"
                </p>
                <input #fileInput type="file" class="hidden" accept=".xlsx,.xls" />
              </div>
              }
            </ng-template>
          </p-fileUpload>
