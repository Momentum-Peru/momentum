...
export class DailyExpensesApiService {
  ...
  list(): Observable<DailyExpense[]> {
    return this.http.get<DailyExpense[]>(`${this.baseUrl}/daily-reports`);
  }
  ...
  getById(id: string): Observable<DailyExpense> {
    return this.http.get<DailyExpense>(`${this.baseUrl}/daily-reports/${id}`);
  }

  create(expense: DailyExpense): Observable<DailyExpense> {
    return this.http.post<DailyExpense>(`${this.baseUrl}/daily-reports`, expense);
  }

  update(id: string, expense: Partial<DailyExpense>): Observable<DailyExpense> {
    return this.http.patch<DailyExpense>(`${this.baseUrl}/daily-reports/${id}`, expense);
  }

  submit(id: string): Observable<DailyExpense> {
    return this.http.patch<DailyExpense>(`${this.baseUrl}/daily-reports/${id}/submit`, {});
  }
  ...
  approve(
    ...
    return this.http.patch<DailyExpense>(`${this.baseUrl}/daily-reports/${id}/approve`, payload);
  }
  ...
  uploadObservationDocument(
    ...
    return this.http.post(
      `${this.baseUrl}/daily-reports/${expenseId}/observations/${observationIndex}/documents`,
      formData
    );
  }
  ...
  uploadPurchaseDocument(expenseId: string, purchaseIndex: number, file: File): Observable<any> {
    ...
    return this.http.post(
      `${this.baseUrl}/daily-reports/${expenseId}/purchases/${purchaseIndex}/documents`,
      formData
    );
  }
