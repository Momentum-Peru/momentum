...
export type RfqStatus = 'Borrador' | 'Publicada' | 'Cerrada' | 'Cancelada';
...
export class RfqsService {
    ...
    createRfq(payload: { title: string, description: string, projectId?: string, items: { productId: string, quantity: number, notes?: string }[], providerIds?: string[], deadline?: string, termsAndConditions?: string }): Observable<Rfq> {
