...
export class TasksApiService {
    ...
    getTasks(params?: TasksSearchParams): Observable<TasksListResponse> {
        ...
        return this.http.get<TasksListResponse>(`${this.baseUrl}/tasks`, { params: params as any })
            .pipe(
                tap(response => {
    ...
    updateTaskStatus(dragEvent: DragDropEvent): Observable<Task> {
        ...
        return this.http.patch<Task>(`${this.baseUrl}/tasks/${dragEvent.taskId}/status`, {
            status: dragEvent.toStatus,
    ...
    searchTasks(searchParams: TasksSearchParams): Observable<TasksListResponse> {
        ...
        return this.http.get<TasksListResponse>(`${this.baseUrl}/tasks/search`, {
